    ...
    <div class="container">
      <div class="row">
	    <div class="col-md-4 col-sm-12 col-xs-12">
          <a href="index.html"><img class="footer-logo" src="Admin/resimler/2599020035brand_logo_01.png" alt=""></a>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="copyrights">Tüm Hakları Saklıdır © <?php echo date("Y"); ?> Melda Teksarı.</div>
        </div>
      </div>
    </div>
  </div>
